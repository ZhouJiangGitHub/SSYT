...
<div class="formbody">
    <div class="formtitle"><span>基本信息</span></div>
    <form id="updatePW" data-validator-option="{timely:3}"
          action="<%=request.getContextPath() %>/LoginServlet?command=updatePW&opeartion=update&id=${user.id }"
          method="post" target="_top">

        <fieldset>
            <div class="form-item">
                <li><label>&nbsp;&nbsp;原密码&nbsp;&nbsp;</label>
                    <input id="PW" class="dfinput" type="password" name="oldpassword" placeholder="原密码"
                           onkeyup="validateOldPW();"/>&nbsp;&nbsp;<i id="oldPWinfo" style="color:red;"></i></li>
                <br/>
            </div>
            <div class="form-item">
                <li><label>&nbsp;&nbsp;新密码&nbsp;&nbsp;</label>
                    <input class="dfinput" id="newPW" type="password" name="newpassword" data-rule="required;password;"
                           placeholder="新密码" onkeyup="validateRepPW();" maxlength="16"/></li>
                <br/>
            </div>
            <div class="form-item">
                <li><label>&nbsp;&nbsp;新密码&nbsp;&nbsp;</label>
                    <input class="dfinput" id="repPW" type="password" name="reppassword" data-rule="required;password;"
                           placeholder="确认密码" onkeyup="validateRepPW()" maxlength="16"/>&nbsp;&nbsp;<i id="repPWinfo"
                                                                                                       style="color:red;">
                </li>
                <br/>
            </div>
        ...
        <div class="form-item">
            <label>&nbsp;&nbsp;&nbsp;&nbsp;</label>
            <button id="sub" class="btn" type="submit" disabled='disabled' onclick="return confirm('确定修改吗？')">修改
            </button>
        </div>
    </form>
</div>
