...
<head>
    ...
    <script type="text/javascript"
            src="<%=request.getContextPath() %>/static/common/js/format+zh_CN,default,corechart.I.js"></script>
    <script type="text/javascript"
            src="<%=request.getContextPath() %>/static/common/js/jquery.gvChart-1.0.1.min.js"></script>
    <script type="text/javascript"
            src="<%=request.getContextPath() %>/static/common/js/jquery.ba-resize.min.js"></script>
    ...
    <div class="mainleft">
        ...
        <div class="leftinfos">
            ...
            <div class="inforight">
                ...
                <ul class="tooli">
                    <li><span><img src="<%=request.getContextPath() %>/static/common/images/d01.png"/></span>
                        <p><a href="#">信息资料</a></p></li>
                    <li><span><img src="<%=request.getContextPath() %>/static/common/images/d02.png"/></span>
                        <p><a href="#">编辑</a></p></li>
                    <li><span><img src="<%=request.getContextPath() %>/static/common/images/d03.png"/></span>
                        <p><a href="#">记事本</a></p></li>
                    <li><span><img src="<%=request.getContextPath() %>/static/common/images/d04.png"/></span>
                        <p><a href="#">任务日历</a></p></li>
                    <li><span><img src="<%=request.getContextPath() %>/static/common/images/d05.png"/></span>
                        <p><a href="#">图片管理</a></p></li>
                    <li><span><img src="<%=request.getContextPath() %>/static/common/images/d06.png"/></span>
                        <p><a href="#">交易</a></p></li>
                    <li><span><img src="<%=request.getContextPath() %>/static/common/images/d07.png"/></span>
                        <p><a href="#">档案袋</a></p></li>
                </ul>
