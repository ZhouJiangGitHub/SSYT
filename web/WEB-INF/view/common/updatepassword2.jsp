...
<div class="formbody">
    ...
    <form action="<%=request.getContextPath() %>/LoginServlet?command=updatePW&opeartion=update&id=${user.id }"
          method="post" target="_top">
        <ul class="forminfo">
            <li><label>原密码</label><input name="oldpassword" id="oldPW" type="password" class="dfinput"
                                         onchange="validate(this.value,'validateOldPW');"/><i id="oldPWinfo"
                                                                                              style="color:red;"></i>
            </li>
            <li><label>新密码</label><input name="newpassword" id="newPW" type="password" class="dfinput"
                                         disabled='disabled' onchange="validate(this.value,'validateNewPW');"/><i
                    id="newPWinfo" style="color:red;"></i></li>
            <li><label>新密码</label><input name="reppassword" id="repPW" type="password" class="dfinput"
                                         disabled='disabled' onchange="validateRepPW()"/><i id="repPWinfo"
                                                                                            style="color:red;"></i></li>

            <!--  onBlur='validateOldPW();' -->
            <!--  <li><label>电　　话</label><textarea name="" cols="" rows="" class="textinput"></textarea></li> -->
            <li><label>&nbsp;</label><input id="updateBT" type="submit" class="btn" value="修改" disabled='disabled'
