...
<body style="background:url(<%=request.getContextPath() %>/static/common/images/topbg.gif) repeat-x;">
    ...
    <div class="topleft">
    <a href="<%=request.getContextPath() %>/ApplicationServlet?command=main" target="_parent"><img src="<%=request.getContextPath() %>/static/common/images/header-logo.png" title="系统首页" /></a>
    </div>
...
<%--     <ul class="nav">
    ...
    <div class="topright">    
    <ul>
    <li><span><img src="<%=request.getContextPath() %>/static/common/images/help.png" title="帮助"  class="helpimg"/></span><a href="<%=request.getContextPath() %>/LoginServlet?command=testpage" target="_top">帮助</a></li>
    <li><a href="<%=request.getContextPath() %>/LoginServlet?command=updatepasswordpage" target="rightFrame">修改密码</a></li>
    <li><a href="<%=request.getContextPath() %>/LoginServlet?command=loginout" target="_parent">退出</a></li>
    </ul>
     
    <div class="user">
    <span><a href="<%=request.getContextPath() %>/LoginServlet?command=user-detail" target="rightFrame">${user.name }</a></span>
    <i>消息</i>
    <b>5</b>
    </div>    
