...
<div class="tools">
    <ul class="toolbar">
        <li>
            <form id="myForm" action="<%=request.getContextPath()%>/ExamServlet?command=List" method="post">
                学员名:<input type="text" name="name" value="${exam.name }" class="form-control"
    ...
    <ul class="toolbar1">
        <li class="click"><a href="<%=request.getContextPath() %>/ExamServlet?command=examAddPage"
                             target="rightFrame"><span><img
                src="<%=request.getContextPath() %>/static/common/images/t01.png"/></span>添加考试记录</a></li>
    </ul>
</div>
