...
<div class="formbody">
    ...
    <form action="<%=request.getContextPath() %>/ClassServlet?command=last" method="post">
        <ul class="forminfo">
            ...
            <li><label>操 作 者</label><input name="operate_user_id" type="text" class="dfinput" value="${cla.course_id}"/>
            </li>
            <li><label>操作时间</label><input name="operate_time" type="text" class="dfinput" value="${cla.operate_time }"/>
            </li>
            <li><label>状　　态</label><input name="state" type="text" class="dfinput" value="${cla.state }"/></li>
            <li><label>备　　注</label><textarea name="memo" rows="" cols="" class="textinput"
                                             value="${cla.memo }"></textarea></li>
