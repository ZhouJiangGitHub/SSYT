...
<div class="tools">
    <ul class="toolbar">
        <li>
            <form id="myForm" action="<%=request.getContextPath()%>/ClassServlet?command=List" method="post">
                班级名:<input type="text" name="name" value="${cla.name }" class="form-control"
    ...
    <ul class="toolbar1">
        <li class="click"><a href="<%=request.getContextPath() %>/ClassServlet?command=classAddPage"
                             target="rightFrame"><span><img
                src="<%=request.getContextPath() %>/static/common/images/t01.png"/></span>新增班级</a></li>
    </ul>
</div>
