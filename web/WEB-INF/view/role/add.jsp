...
<body>
    ...
    <li><label></label><input type="text"
					class="dfinput" name="operateUserId" id="operateUserId"  style="display:none;" value="${opread_user_id }" /><span
					id="password2Info"></span></li>
    <li><label>角色名：</label><input type="text"  class="dfinput" name="name" id="name" /><span id="codeInfo"></span></li>
