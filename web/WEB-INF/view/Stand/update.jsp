...
<div class="formbody">
    ...
    <form action="<%=request.getContextPath() %>/StandServlet?command=last" method="post">
        <ul class="forminfo">
            ...
            <li><label>指定接受者(个人)</label><input name="receiver_user_ids" type="text" class="dfinput"
                                               value="${sta.receiver_user_ids }"/></li>
            <li><label>过期时间</label><input name="expire_time" type="text" class="dfinput" value="${sta.expire_time }"/>
            </li>
            <li><label>状　　态</label>
            ...
            <li><label>&nbsp;</label><input type="submit" class="btn" value="修改" onclick="return confirm('确定修改吗？');"/>
            </li>
        </ul>
    </form>
