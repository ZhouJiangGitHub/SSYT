...
<div class="formbody">
    ...
    <form action="<%=request.getContextPath() %>/StandServlet?command=delete&id=${sta.id}" method="post">
        <ul class="forminfo">
            ...
            <li><label>过期时间</label><input name="expire_time" type="Date" class="dfinput" value="${sta.expire_time }"/>
            </li>
            <li><label>状　　态</label>
            ...
            <li><label>&nbsp;</label><input type="submit" class="btn" value="删除" onclick="return confirm('确定删除吗？');"/>
            </li>
        </ul>
    </form>
