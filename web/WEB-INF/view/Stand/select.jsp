...
<div class="tools">
    <ul class="toolbar">
        <li>
            <form id="myForm" action="<%=request.getContextPath()%>/StandServlet?command=List" method="post">
                标题:<input type="text" name="title" value="${sta.title }" class="form-control"
    ...
    <ul class="toolbar1">
        <li class="click"><a href="<%=request.getContextPath() %>/StandServlet?command=standAddPage"
                             target="rightFrame"><span><img
                src="<%=request.getContextPath() %>/static/common/images/t01.png"/></span>站内信息新增</a></li>
    </ul>
</div>
<table width="100%" boeder="1" type=" font-weigth:16px">
    ...
    <tr>
        <td colspan="9" align="right"><a
            ...
            当前为第${pageModel.pageNo }页,共${pageModel.allRecords }条记录。
        </td>
    </tr>
