...
<head>
    ...
    <link rel="stylesheet"
          href="<%=request.getContextPath() %>/static/common/plugin/zTree_v3-master/css/zTreeStyle/zTreeStyle.css"
          type="text/css">
...
<div class="content_wrap">
    <div class="zTreeDemoBackground left">
        ...
        <center id="insertCourse" style="display: none;"><input type="button" value="添加课程" onclick="insertCourse();"/>
        </center>
    </div>
            ...
            <ul class="info">
                <li class="title"><h2>课程信息</h2>
                    <ul class="list">
                        ...
                        <li class="highlight_red" style="display: none;">课程Id：<input type="text" name="id" id="id"/>
                        </li>
                        <br/>
                        <li class="highlight_red">父 节 点:<input type="text" name="pName" id="pName" disabled="disabled"/>
                        </li>
                        <br/>
                        <li class="highlight_red">课程名称:<input type="text" name="name" id="name"
                                                              onkeyup="validateCourse();"/><span id="nameInfo"
                        ...
                        <li class="highlight_red">操 作 者:<input type="text" name="operateUser" id="operateUser"
                                                               disabled="disabled"/></li>
                        <br/>
                        <li class="highlight_red">操作时间:<input type="text" name="operateTime" id="operateTime"
                                                              disabled="disabled"/></li>
                        <br/>
                        <li class="highlight_red">备　　注:<textarea rows="6" cols="50" style="vertical-align:top;"
                                                                 name="memo" id="memo"></textarea></li>
                        <br/>
                        <li class="highlight_red"><input type="submit" id="updateSubmit" value="修改"
                                                         onclick="return confirm('确定修改该课程吗？');" disabled="disabled"/>
                        </li>
                        <br/>
                    </ul>
                </li>
            ...
            <ul class="info">
                <li class="title"><h2>添加课程</h2>
                    <ul class="list">
                        ...
                        <li class="highlight_red" style="display: none;">父节点Id:<input type="text" name="newPId"
                                                                                      id="newPId"/></li>
                        <br/>
                        ...
                        <li class="highlight_red">父 节 点:<input type="text" name="newPName" id="newPName"
                                                               disabled="disabled"/></li>
                        <br/>
                        <li class="highlight_red">课程名称:<input type="text" name="newName" id="newName"
                                                              onkeyup="validate();"/><span id="newNameInfo"
                                                                                           style="color:red;"></span>
                        </li>
                        <br/>
                        ...
                        <li class="highlight_red">备　　注:<textarea rows="6" cols="50" style="vertical-align:top;"
                                                                 name="memo"></textarea></li>
                        <br/>
                        <li class="highlight_red"><input type="submit" id="insertSubmit" value="添加"
                                                         onclick="return confirm('确定添加该课程吗？');" disabled="disabled"/>
                        </li>
                        <br/>
                    </ul>
                </li>
