...
public class ExamManageDao {
	 ...
	 * 
	 */     
	public static PageModel<ExamManageEntity> listExamManageByPage(int pageNo,
			int PageSize) {
		...
		//sb.append("SELECT b.name AS  FROM  sys_user a , sys_class b , sys_role c  ");
		//sb.append("SELECT where a.role_id = c.id and a.class_id = b.id  LIMIT ?,? ");
		//String sql = "SELECT * FROM  exam_plan a , qes_exam_paper b  where a.exam_paper_id = b.id LIMIT ?,?";
